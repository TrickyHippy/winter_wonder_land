...
def KaufeAugustin(items, money):
    while True:
        augustin = input("If you want to buy the newspaper for 3€ type: y," +
                         "if you want to give the homeless person 50 Cent type: 50" +
...
if you don't want a drink, type n'\n""")
        if purchase == "0":
            if money >= drink_prices[random_items[0]]:
                ...
                if random_items[0] == "Rum" or random_items[0] == "Glühwein" or random_items[0] == "Punsch":
                    promille += 1
                if bought_drink == False:
            ...
            if money >= drink_prices[random_items[1]]:
                ...
                PrintSleep(f"Your new capital is: {money}€")
                if random_items[1] == "Rum" or random_items[1] == "Glühwein" or random_items[1] == "Punsch":
                    promille += 1
                if bought_drink == False:
                    PrintSleep("Now you are not thirsty anymore.")
                    bought_drink = True
            ...
            if money >= drink_prices[random_items[2]]:
                ...
                PrintSleep(f"Your new capital is: {money}€")
                if random_items[2] == "Rum" or random_items[2] == "Glühwein" or random_items[2] == "Punsch":
                    promille += 1
                if bought_drink == False:
                    PrintSleep("Now you are not thirsty anymore.")
                    bought_drink = True
...
def Anger(items, money, bought_toy):
    ...
    while True:
        ...
        if purchase.lower() == "y" and money >= toys_prices[toys[random_index]]:
        ...
        elif purchase.lower() == "y" and money < toys_prices[toys[random_index]]:
...
""")
        if action.lower() == "hungry":
            ...
            money, is_break, bought_drink, promille = Thirst(money, bought_drink, promille)
            if is_break == True:
                break
        elif action.lower() == "angry":
            items, money, is_break, bought_toy = Anger(items, money, bought_toy)
            if is_break == True:
                break
    ...
    elif bought_drink == True and bought_food == True and bought_toy == True:
